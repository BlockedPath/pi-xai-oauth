...
export const XAI_OAUTH_REQUEST_TIMEOUT_MS = 15 * 1000;
export const XAI_OAUTH_MAX_RESPONSE_BYTES = 64 * 1024;
export const XAI_OAUTH_DEVICE_REQUEST_TIMEOUT_MS = XAI_OAUTH_REQUEST_TIMEOUT_MS;
export const XAI_OAUTH_DEVICE_MAX_RESPONSE_BYTES = XAI_OAUTH_MAX_RESPONSE_BYTES;
